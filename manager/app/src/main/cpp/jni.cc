...
extern "C"
JNIEXPORT jint JNICALL
Java_com_sukisu_ultra_Natives_getKernelUAPIVersion(JNIEnv *env, jobject) {
    return get_kernel_uapi_version();
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_sukisu_ultra_Natives_getManagerUAPIVersion(JNIEnv *env, jobject) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_sukisu_ultra_Natives_setSelinuxEnforce(JNIEnv *env, jobject thiz, jboolean enforce) {
    return set_selinux_enforce(enforce);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_sukisu_ultra_Natives_isSelinuxEnforce(JNIEnv *env, jobject thiz) {
